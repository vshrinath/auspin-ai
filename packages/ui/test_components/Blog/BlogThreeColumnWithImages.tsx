...
import type { BlogPost, BlogThreeColumnWithImagesProps } from './types'
...
export default function BlogThreeColumnWithImages({
...
export type { BlogPost, BlogThreeColumnWithImagesProps } from './types'

...
import type { HeaderLink, HeaderStat, HeaderWithStatsProps } from './types'
...
const DEFAULT_PROPS: Required<Omit<HeaderWithStatsProps, 'className'>> = {
  eyebrow: undefined,
  title: 'Work with us',
  description:
...
export type { HeaderLink, HeaderStat, HeaderWithStatsProps } from './types'

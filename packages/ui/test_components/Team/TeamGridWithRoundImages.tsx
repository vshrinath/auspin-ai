...
import type { TeamGridWithRoundImagesProps, TeamMember } from './types'
...
const DEFAULT_PROPS: TeamGridWithRoundImagesProps = {
  title: 'Our team',
  description:
...
export type { TeamGridWithRoundImagesProps, TeamMember } from './types'

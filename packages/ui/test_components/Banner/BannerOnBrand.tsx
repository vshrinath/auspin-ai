...
const DEFAULT_TONE_CLASSES: BannerToneClasses = {
  container: 'flex items-center gap-x-6 bg-indigo-600 px-6 py-2.5 sm:px-3.5 sm:before:flex-1',
...
export default function BannerOnBrand({
...
export type { BannerOnBrandProps } from './types'

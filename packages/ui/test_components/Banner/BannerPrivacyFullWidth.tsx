...
const DEFAULT_TONE_CLASSES: BannerToneClasses = {
  container:
    'fixed inset-x-0 bottom-0 flex flex-col justify-between gap-x-8 gap-y-4 border-t border-gray-900/10 bg-white p-6 shadow-lg md:flex-row md:items-center lg:px-8',
...
export default function BannerPrivacyFullWidth({
...
export type { BannerPrivacyFullWidthProps } from './types'

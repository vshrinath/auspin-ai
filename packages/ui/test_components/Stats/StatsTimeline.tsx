...
import type { StatsTimelineItem, StatsTimelineProps } from './types'

const DEFAULT_TIMELINE: StatsTimelineItem[] = [
  {
...
export type { StatsTimelineItem, StatsTimelineProps } from './types'

...
import type { PricingThreeTiersComparisonTableProps, PricingTier, PricingComparisonSection } from './types'

const DEFAULT_TIERS: PricingTier[] = [
  { name: 'Starter', id: 'tier-starter', href: '#', priceMonthly: '$19', mostPopular: false, description: '', features: [] },
  { name: 'Growth', id: 'tier-growth', href: '#', priceMonthly: '$49', mostPopular: true, description: '', features: [] },
  { name: 'Scale', id: 'tier-scale', href: '#', priceMonthly: '$99', mostPopular: false, description: '', features: [] },
]

const DEFAULT_SECTIONS: PricingComparisonSection[] = [
  {
    name: 'Features',
    features: [
...
const DEFAULT_PROPS: PricingThreeTiersComparisonTableProps = {
  eyebrow: 'Pricing',
...
export default function PricingThreeTiersComparisonTable({
  ...
  className = '',
}: PricingThreeTiersComparisonTableProps = {}) {
...
export type { PricingComparisonSection, PricingThreeTiersComparisonTableProps, PricingTier } from './types'

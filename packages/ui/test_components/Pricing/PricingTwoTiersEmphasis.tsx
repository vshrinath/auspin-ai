...
import type { PricingTier, PricingTwoTiersEmphasisProps } from './types'
...
const DEFAULT_PROPS: PricingTwoTiersEmphasisProps = {
  eyebrow: 'Pricing',
...
export default function PricingTwoTiersEmphasis({
  ...
  const rootClassName = ['relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8', className]
    .filter(Boolean)
    .join(' ')
...
export type { PricingTier, PricingTwoTiersEmphasisProps } from './types'

...
import type { PricingThreeTiersProps, PricingTier } from './types'
...
export default function PricingThreeTiers({
  ...
  className = '',
  defaultCtaLabel = DEFAULT_PROPS.defaultCtaLabel,
...
export type { PricingThreeTiersProps, PricingTier } from './types'

/**
 * TeamFullWidthVerticalImages - Full width vertical images
 *
 * @pattern Team
 * @variant Full width vertical images
 * @component TeamFullWidthVerticalImages
 * @source Tailwind UI
 * @usage A Full width vertical images Team component from Tailwind UI
 * @framework agnostic
 * @dependencies react
 */

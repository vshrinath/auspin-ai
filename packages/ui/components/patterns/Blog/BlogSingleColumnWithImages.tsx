/**
 * BlogSingleColumnWithImages - Single column with images
 *
 * @pattern Blog
 * @variant Single column with images
 * @component BlogSingleColumnWithImages
 * @source Tailwind UI
 * @usage A Single column with images Blog component from Tailwind UI
 * @framework agnostic
 * @dependencies react
 */

/**
 * PricingThreeTiersComparisonTable - Three tiers comparison table
 *
 * @pattern Pricing
 * @variant Three tiers comparison table
 * @component PricingThreeTiersComparisonTable
 * @source Tailwind UI
 * @usage A Three tiers comparison table Pricing component from Tailwind UI
 * @framework agnostic

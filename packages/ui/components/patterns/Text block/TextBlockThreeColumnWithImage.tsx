/**
 * TextBlockThreeColumnWithImage - Three column with image
 *
 * @pattern Text block
 * @variant Three column with image
 * @component TextBlockThreeColumnWithImage
 * @source Tailwind UI
 * @usage A Three column with image Text block component from Tailwind UI
 * @framework agnostic
 * @dependencies react
 */

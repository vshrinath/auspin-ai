/**
 * BentoGridTwoRowWithThreeColumn - Two row with three column
 *
 * @pattern Bento Grid
 * @variant Two row with three column
 * @component BentoGridTwoRowWithThreeColumn
 * @source Tailwind UI
 * @usage A Two row with three column Bento Grid component from Tailwind UI
 * @framework agnostic
 * @dependencies react
 */

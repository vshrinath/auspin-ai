/**
 * PageHeadingsCardWithAvatarAndActions - card with avatar and actions
 *
 * @pattern Page headings
 * @variant card with avatar and actions
 * @component PageHeadingsCardWithAvatarAndActions
 * @source Tailwind UI
 * @usage A card with avatar and actions Page headings component from Tailwind UI
 * @framework agnostic
 * @dependencies react
 */

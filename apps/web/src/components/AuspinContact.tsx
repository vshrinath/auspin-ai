    ...
    <div id="contact" className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
          Let's De-risk Your AI Execution
        </h2>
        <p className="mt-2 text-lg leading-8 text-gray-600">
          <span className="font-semibold">Primary markets:</span> India • Southeast Asia • Middle East
        </p>
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Start with a 2-day Alignment Sprint or a 3-week Feasibility Sprint.
        </p>
      </div>
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div className="sm:col-span-2">
            <label htmlFor="name" className="block text-sm leading-6 font-semibold text-gray-900">
              Name *
            </label>
          ...
          <div className="sm:col-span-2">
            <label htmlFor="companyRole" className="block text-sm leading-6 font-semibold text-gray-900">
              Company & Role
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="region" className="block text-sm leading-6 font-semibold text-gray-900">
              Region
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="outcome" className="block text-sm leading-6 font-semibold text-gray-900">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          ...
          <a
            href="mailto:hello@auspinventures.com"
            className="flex-1 rounded-md px-3.5 py-2.5 text-center text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
          >
            Ask a Question
          </a>
        </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-sm text-gray-500">
          Case evidence available under NDA. © AUSPIN Ventures
        </p>
      </div>
    </div>
  );

...
export function ContactForm({
  ...
  const [formData, setFormData] = useState<FormData>(() => {
    ...
    fields.forEach((field) => {
      initialData[field.name] = field.name === 'service' && preselectedService ? preselectedService : '';
    });
    return initialData;
  });
      ...
      default:
        return (
          <Input
            ...
            type="text"
            onChange={(e) => handleChange(field.name, e.target.value)}
            autoComplete={field.name === 'name' ? 'name' : field.name === 'company' ? 'organization' : undefined}
          />
        );
    }
  };

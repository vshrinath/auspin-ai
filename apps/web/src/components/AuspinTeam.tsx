...
const people = [
  ...
  },
  {
    ...
    bio: "30+ years across innovation, strategy, and market expansion. Leads strategic initiatives and corporate governance at a global tech conglomerate, steering AI-led transformation and sustainability programs across India, the Middle East, and Southeast Asia.",
      ...
      <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="max-w-xl">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Practitioner-led, not slide-led. You work directly with leaders who&apos;ve
            shipped at scale across Big Tech, enterprise transformation, and global
            advisory work.
          </p>
          <div className="mt-8">
            <a
              ...
              <li key={person.name}>
                <div className="flex items-start gap-x-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm leading-6 font-semibold text-indigo-600 mb-2">
                      {person.role}
                    </p>

          ...
          <div className="relative">
            <div className="bg-white rounded-2xl p-8 border border-red-100 shadow-sm">
              ...
              <div className="text-center mb-8">
                ...
                <div className="text-lg text-gray-700">of AI pilots fail</div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600">Actually Scale & Succeed</span>
                  </div>
              ...
              <div className="mt-8 p-4 bg-red-100 rounded-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-red-800">Wasted Investment</div>
                    <div className="text-xs text-red-600">Millions spent on failed pilots</div>
                  </div>
                </div>
              </div>
            </div>

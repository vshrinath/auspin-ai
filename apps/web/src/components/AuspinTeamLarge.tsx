      ...
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Direct access to practitioners. No intermediaries, no junior consultants—just leaders who built and scaled AI at Amazon and coached leaders at global enterprises.
          </p>
        </div>
        <ul
          role="list"
        ...
        >
          {coreTeam
            ...
            .map((person) => (
            <li key={person.name} className="rounded-2xl bg-gray-50 px-8 py-10 flex flex-col h-full hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              <img
                alt={person.name}
                src={person.imageUrl}
              ...
              <p className="mt-4 text-sm leading-6 text-gray-600 text-left max-w-lg mx-auto flex-grow">{person.bio}</p>
              <ul role="list" className="mt-6 flex justify-center gap-x-6">

                <li>
                  <a href={person.linkedinUrl} className="text-gray-400 hover:text-indigo-600 transition-colors duration-200">
        ...
        {/* Advisors Section */}
        <div className="mt-16">
          <h3 className="text-2xl font-semibold text-gray-900 text-center mb-12">Advisors</h3>
          <ul
            role="list"

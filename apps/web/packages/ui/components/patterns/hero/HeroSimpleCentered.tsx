/**
 * Tailwind UI pattern component.
 * @pattern hero
 * @variant simple centered
 * @component HeroSimpleCentered
 * @source Tailwind UI
 * @usage Responsive, reusable across frameworks.
 * @framework agnostic
...
const HeroSimpleCentered = (): JSX.Element => {
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl sm:leading-8">
